...
def test_set_select():
    ...
    filepath = r'./dataset/english_email'
    testpath = r'./dataset/english_email/test'
...
def count_word_prob(email_list, union_set):
    ...
    for word in union_set:
        ...
        if counter != 0:
            ...
            '''进在某一分类中未出现则令该分类下该词词频TF=0.01，0.05，……，越大越会把spam误判成ham'''
            prob = 0.01
        word_prob[word] = prob
    return word_prob
...
def main():
    ...
    ham_file = r'./dataset/english_email/ham'
    spam_file = r'./dataset/english_email/spam'
    test_file = r'./dataset/english_email/test'
    for i in range(100):
